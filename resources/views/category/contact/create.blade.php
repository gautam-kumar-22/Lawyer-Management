@extends('layouts.master', ['title' => __('Create New Contact Category')])
            ...
            <div class="col-12">
                <div class="box_header">
                    <div class="main-title d-flex justify-content-between w-100">
                        <h3 class="mb-0 mr-30">{{ __('New Contact Category') }}</h3>
                ...
                <div class="col-12">
                    ...
                    <div class="primary_input">
                        ...
                        {{Form::textarea('description', null, ['class' => 'primary_input_field', 'placeholder' =>
                         __('Designation Description'), 'rows' => 5, 'maxlength' => 1500,
