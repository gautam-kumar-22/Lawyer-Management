                ...
                <div class="modal-body">
                    <form action="{{ route('profile.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="primary_input mb-25">
                                    <label class="primary_input_label" for="">{{ __('common.Username') }} <span class="text-danger">*</span></label>
                                    <input name="username" class="primary_input_field name" placeholder="{{ __('common.Username') }}" value="{{ $user->username }}" type="text" readonly>
