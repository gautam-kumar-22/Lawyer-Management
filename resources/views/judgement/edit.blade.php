...
<div class="row">
          <div class="primary_input col-md-12">
            ...
            {{Form::text('judgement_date', $model->date, ['required' => '','class' => 'primary_input_field primary-input date form-control date', 'placeholder' => __('case.Judgement Date')])}}
          </div>
        </div>
        <div class="primary_input">
          {{Form::label('description', __('case.Description'), ['class' => 'required'])}}
          {{Form::textarea('description', null, ['required' => '','class' => 'primary_input_field summernote', 'placeholder' => __('case.Date Description'), 'required', 'rows' => 5, 'data-parsley-errors-container' =>
          '#description_error' ])}}
