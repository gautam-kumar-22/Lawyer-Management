                    ...
                    {!! Form::open(['route' => 'master.court.store', 'class' => 'form-validate-jquery', 'id' => 'content_form', 'files' => false, 'method' => 'POST']) !!}
                        <div class="row">
                            ...
                            <div class="primary_input col-md-4">
                                ...
                                {{Form::select('city_id',[''=> 'Select State Fast'], null, ['class' => 'primary_select','id' => 'city_id', 'data-placeholder' => __('court.Select city'), 'data-parsley-errors-container' => '#city_id_error'])}}
